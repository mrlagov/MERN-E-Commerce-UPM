...
class AddToCart extends Component {
  ...
  render() {
    ...
    return (<span>
      {this.props.item.quantity >= 0 && this.props.item.type  === 'URL' ||  this.props.item.type  === 'API'?
        <IconButton sx={{ fontSize: 40 }} color="secondary" dense="dense" onClick={this.addToCart}>
