            ...
            return <span key={i}>
              <Card className={classes.card}>
                <CardMedia
                  ...
                  image={'http://localhost:3000/api/products/'+item.type+'/photo/'+item._id}
                  title={item.name}
                />
                  ...
                  <CardContent className={classes.content}>
                    ...
                    <Link to={'/shops/'+item.shop}>
                      <Typography type="subheading" className={classes.subheading}>
                        <Icon className={classes.icon}>Carrito de la compra</Icon> 
                      </Typography>
                    </Link>
                    <Typography component="p" className={classes.date}>
                        Aniadir {(new Date(item.created)).toDateString()}
                    </Typography>
                  </CardContent>
